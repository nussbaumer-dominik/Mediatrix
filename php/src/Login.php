...
preg_match('/^[A-Za-z0-9]+$/',$_POST['username']) or die('{"success":false,"err":"uUsername not valid"}');
preg_match('/^[A-Za-z0-9]+$/',$_POST['password']) or die('{"success":false,"err":"uUsername not valid"}');
